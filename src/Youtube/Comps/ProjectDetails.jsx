          ...
          <div className="flex flex-col">
            <div id="introduction" className="mt-5 mx-2 flex flex-col gap-1">
              ...
              <p className="font-SagarFont font-light text-lg">
                ...
                the proportion of likes, and views ratio, giving an indication
                of viewer engagement. This tool is valuable for content creators
                and marketers, as it helps them understand{" "}
                <span className="text-red-500 font-medium">
                  {" "}
                  audience sentiment
                </span>
            ...
            <div id="methodology" className="mt-10 mx-2 flex flex-col gap-2">
              ...
              <div id="dataCollection" className="flex flex-col mt-3">
                ...
                <p className="font-SagarFont font-light text-lg">
                  ...
                  lectures, and music. After scraping, comments were labeled
                  into
                  <span className="text-red-500 font-medium">
                    {" "}
                    5 categories{" "}
              ...
              <div id="modelBuilding" className="flex flex-col mt-5">
                ...
                <p className="font-SagarFont font-light text-lg">
                  After collection and preprocessing, the data is trained using
                  an
                  ...
                  . This LSTM layer has 100 units and a dropout of 0.4 to
                  prevent overfitting. It uses optimization algorithms being
                  more specific{" "}
              ...
              <div id="testing" className="flex flex-col mt-5">
                ...
                <p className="font-SagarFont font-light text-lg">
                  ...
                  <span className="text-red-500 font-medium"> 2,842</span>{" "}
                  testing data. The LSTM achieves an overall accuracy of{" "}
            ...
            <div id="limitation" className="my-10 mx-2 flex flex-col gap-1">
              ...
              <p className="font-SagarFont font-light text-lg">
                ...
                only, it won't properly analyze comments in other languages.
                This{" "}
                <span className="text-red-500 font-medium">
                  {" "}
                  limitation
                </span>{" "}
                arises because the model learns patterns specific to English
                text. When presented with comments in other languages, it may{" "}
                <span className="text-red-500 font-medium">
                  {" "}
                  misinterpret
                </span>{" "}
                or fail to recognize the meaning accurately.
              </p>
            </div>
          </div>

          <a
            href="https://github.com/sagar-tandan/Yt-Comment-Analyzer"
            target="_blank"
          >
            <div className="flex w-full justify-end items-center p-2 mb-10">
              <span className="font-SagarFont font-semibold hover:text-red-600 text-md hover:cursor-pointer transition-all ease-in-out duration-200 active:scale-90">
                View Github Code
              </span>
            </div>
          </a>
